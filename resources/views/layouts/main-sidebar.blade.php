<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active d-flex align-items-center" href="{{ route('home') }}">
                    <img src="{{ asset('assets/img/invoice.png') }}" class="main-logo" alt="logo">
                </a>
			</div>
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">{{ config('app.name') }}</li>
					<li class="slide">
